        ...
        <div className="card">
          ...
          <div className="card">
            ...
            >
              ...
              <p className="description">
                A dynamic card form with 3d animations that can be used for
                e-commerce
              </p>
            </a>
          </div>
          ...
          <div className="card">
            ...
            >
              ...
              <p className="description">
                A Facebook clone with Google Authentication and realtime
                Firestore DB. Leave a comment!
              </p>
            </a>
          </div>
          ...
          <div className="card">
            ...
            >
              ...
              <h4>Dark-Mode</h4>
              <p className="description">
                A simple theme to toggle by clicking on the sun and the moon.
              </p>
            </a>
          </div>
          ...
          <div className="card">
            ...
            >
              ...
              <p>
                Bootstrap interface of current cryptocurrency prices using the
                Coingecko api
              </p>
            </a>
          </div>
          ...
          <div className="card">
            ...
            >
              ...
              <h4>Media finder</h4>
              <p>
                A multimedia content search engine (movies, shows, books, etc)
                using OMDB API and Bootstrap
              </p>
            </a>
          </div>
        </div>
